...
async function fetchFlightPicker(date) {
  const response = await fetch(`https://skyscanner-skyscanner-flight-search-v1.p.rapidapi.com/apiservices/browsedates/v1.0/US/RUB/en-US/SVO-sky/JFK-sky/${date}?inboundpartialdate=2021-03`, {
    method: 'GET',
    headers: {
      'x-rapidapi-key': '6e03ab9a43msh8992a5c19c25fecp1e8913jsn89eb12efedd6',
      'x-rapidapi-host': 'skyscanner-skyscanner-flight-search-v1.p.rapidapi.com',
